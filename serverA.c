...
#define MYPORT "21341"    // the port ServerA will be connecting to
...
int main(void)
{
    ...
    printf("%s\n","The Server A is up and running using UDP on port 21341" );
  ...
  //Compute the result and send the result to the server.
    ...
    char *sendResult;
    char buffer[100000];                                                        //Beej Guide reference ends
    ...
    printf("The Server A has successfully finished the reduction %s : %s\n", buf,sendResult);
